...
const policies = [
  {
    icon: FiAward,
    text: "We Strive for Excellence in all Endeavors.",
  },
  {
    icon: FiTarget,
    text: "We Set our Goals to Achieve Customer Satisfaction and to Deliver Defect Free Product Services.",
  },
  {
    icon: FiUsers,
    text: "Implementation of this Policy Makes it Essential that each Person be Committed to Perform Exactly as Specified.",
  },
  {
    icon: FiShield,
    text: "It is our Basic Operational Philosophy to Concentrate on Prevention Method to Make Quality a way of Life and Perpetuate an Attitude of 'Do it Right the First Time'.",
  },
  {
    icon: FiCheckCircle,
    text: "We are Committed to Achieve this by Providing Adequate Resources and Trained Manpower Who Strictly Adhere to the Procedures of ISO 9001:2015 Quality Management System (QMS).",
  },
];
...
export default function QualityPolicyPage() {
  return (
    <>
      <Topbar />
      <Navbar />
      <main className="flex-1 bg-cream/30 py-16 md:py-24">
        <Container>
          <SectionHeading
            eyebrow="Our Commitment"
            title="Quality Policy"
            subtitle="At Grameen Enterprise and Fashion, quality is not just a standard—it's our way of life."
          />
          ...
          <div className="max-w-4xl mx-auto mt-12 space-y-6">
            {policies.map((policy, i) => (
              ...
              >
                <div className="h-16 w-16 flex-shrink-0 rounded-2xl bg-forest/10 text-forest flex items-center justify-center group-hover:bg-forest group-hover:text-cream transition-colors duration-300">
          ...
          {/* ISO Certification Badge Section */}
          <motion.div 
